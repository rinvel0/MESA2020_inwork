...
mesa_rc mesa_conv_vtss_serdes_mode_t_to_mesa_serdes_mode_t(const vtss_serdes_mode_t *in, mesa_serdes_mode_t *out) /* ag.rb:1656 */
{
    switch (*in) {
        ...
        // skipped: VTSS_SERDES_MODE_QXGMII
        // skipped: VTSS_SERDES_MODE_DXGMII_10G
        // skipped: VTSS_SERDES_MODE_DXGMII_5G
...
#ifdef __cplusplus
    static_assert(sizeof(vtss_inst_t) == sizeof(mesa_inst_t), "Check size"); /* ag.rb:1932 */
    static_assert(sizeof(vtss_restart_status_t) == sizeof(mesa_restart_status_t), "Check size"); /* ag.rb:1932 */
#endif // __cplusplus

    return vtss_restart_status_get((const vtss_inst_t)inst /* ag.rb:1847 */, (vtss_restart_status_t *)status /* ag.rb:1844 */); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_restart_status_get(const mesa_inst_t inst, mesa_restart_status_t *const status)
{
...
#ifdef __cplusplus
    static_assert(sizeof(vtss_inst_t) == sizeof(mesa_inst_t), "Check size"); /* ag.rb:1932 */
    static_assert(sizeof(vtss_restart_t) == sizeof(mesa_restart_t), "Check size"); /* ag.rb:1932 */
#endif // __cplusplus

    return vtss_restart_conf_get((const vtss_inst_t)inst /* ag.rb:1847 */, (vtss_restart_t *)restart /* ag.rb:1844 */); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_restart_conf_get(const mesa_inst_t inst, mesa_restart_t *const restart)
{
...
{ /* ag.rb:1822 */
    ...
    return vtss_restart_conf_set((const vtss_inst_t)inst /* ag.rb:1847 */, *((const vtss_restart_t *)&restart) /* ag.rb:1849 */); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_restart_conf_set(const mesa_inst_t inst, const mesa_restart_t restart)
{
...
#ifdef __cplusplus
    static_assert(sizeof(vtss_inst_t) == sizeof(mesa_inst_t), "Check size"); /* ag.rb:1932 */
    static_assert(sizeof(vtss_irq_t) == sizeof(mesa_irq_t), "Check size"); /* ag.rb:1932 */
    static_assert(sizeof(vtss_irq_conf_t) == sizeof(mesa_irq_conf_t), "Check size"); /* ag.rb:1932 */
#endif // __cplusplus

    return vtss_irq_conf_get((const vtss_inst_t)inst /* ag.rb:1847 */, *((const vtss_irq_t *)&irq) /* ag.rb:1849 */, (vtss_irq_conf_t *)conf /* ag.rb:1844 */); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_irq_conf_get(const mesa_inst_t inst, const mesa_irq_t irq, mesa_irq_conf_t * conf)
{
...
{ /* ag.rb:1822 */
    ...
    return vtss_irq_conf_set((const vtss_inst_t)inst /* ag.rb:1847 */, *((const vtss_irq_t *)&irq) /* ag.rb:1849 */, (const vtss_irq_conf_t *)conf /* ag.rb:1844 */); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_irq_conf_set(const mesa_inst_t inst, const mesa_irq_t irq, const mesa_irq_conf_t *const conf)
{
...
{ /* ag.rb:1822 */
    ...
    return vtss_irq_enable((const vtss_inst_t)inst /* ag.rb:1847 */, *((const vtss_irq_t *)&irq) /* ag.rb:1849 */, enable); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_irq_enable(const mesa_inst_t inst, const mesa_irq_t irq, mesa_bool_t enable)
{
...
#endif  // defined(VTSS_ARCH_OCELOT) || defined(VTSS_ARCH_JAGUAR_2) || defined(VTSS_ARCH_SPARX5) /* TBD_henrikb */ /* ag.rb:1965 */
#else
mesa_rc mesa_ts_alt_clock_saved_get(const mesa_inst_t inst, uint64_t *const saved)
{
    return MESA_RC_NOT_IMPLEMENTED;
...
#ifdef __cplusplus
    static_assert(sizeof(vtss_inst_t) == sizeof(mesa_inst_t), "Check size"); /* ag.rb:1932 */
    static_assert(sizeof(vtss_voe_allocation_t) == sizeof(mesa_voe_allocation_t), "Check size"); /* ag.rb:1932 */
#endif // __cplusplus

    return vtss_voe_alloc((const vtss_inst_t)inst /* ag.rb:1847 */, (const vtss_voe_allocation_t *)param /* ag.rb:1844 */, voe_idx); /* ag.rb:1952*/ 
}
#else
mesa_rc mesa_voe_alloc(const mesa_inst_t inst, const mesa_voe_allocation_t *const param, mesa_voe_idx_t *const voe_idx)
{
